import{_ as s,c as n,o as a,V as l}from"./chunks/framework.25f281e8.js";const d=JSON.parse('{"title":"vue 原理相关总结","description":"","frontmatter":{},"headers":[],"relativePath":"interview/vue/vue.md","filePath":"interview/vue/vue.md"}'),p={name:"interview/vue/vue.md"},e=l(`<h1 id="vue-原理相关总结" tabindex="-1">vue 原理相关总结 <a class="header-anchor" href="#vue-原理相关总结" aria-label="Permalink to &quot;vue 原理相关总结&quot;">​</a></h1><h2 id="一、vue2-0-的双向绑定是怎么实现的" tabindex="-1"><strong>一、vue2.0 的双向绑定是怎么实现的</strong> <a class="header-anchor" href="#一、vue2-0-的双向绑定是怎么实现的" aria-label="Permalink to &quot;**一、vue2.0 的双向绑定是怎么实现的**&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight has-diff"><code><span class="line"><span style="color:#A6ACCD;">1、view和model相互实时更新原理：Object.defineProperty数据劫持+发布者-订阅者(依赖收集)模式</span></span>
