import{_ as s,c as n,o as a,a as p}from"./app.61809bb9.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"framework/project/git.md"}'),l={name:"framework/project/git.md"},e=p(`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">git add .</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,2),t=[e];function o(c,r,i,C,A,d){return a(),n("div",null,t)}const y=s(l,[["render",o]]);export{g as __pageData,y as default};
