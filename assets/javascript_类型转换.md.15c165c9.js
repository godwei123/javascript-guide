...
<span class="line"><span style="color:#A6ACCD;">4. 否则抛异常。</span></span></code></pre></div><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">#### 1、== 操作符的强制类型转换规则</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">5. {} 转换为 NaN</span></span></code></pre></div>`,4),o=[e];function c(t,r,C,A,i,y){return a(),n("div",null,o)}const b=s(p,[["render",c]]);export{u as __pageData,b as default};
