import{_ as s,o as n,c as a,g as p}from"./app.caa83a2e.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"framework/project-management/git.md"}'),e={name:"framework/project-management/git.md"},l=p(`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">git add .</span></span>
