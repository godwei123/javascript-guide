...
8.用 CSS 绘制一条 0.5px 的线

9.谷歌浏览器怎么设置小于 12px 的字体
...
22.js 声明变量 var ，const，let 的区别

23.const 声明的变量可以修改吗？const 声明的对象的属性可以修改吗？
...
30.vue 中 computed 和 watch 的区别？

31.在 vue 中一般用哪个声明周期请求异步数据？

32.http 常用的状态码

33.vue 中$nextTick 的原理及作用
