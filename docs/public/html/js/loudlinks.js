...
var loudlinks = (function (document) {
  ...
  let audioPlayer = document.createElement("audio"),
    ...
    mp3Location = "music/sounds/mp3/", // mp3 sounds location
    oggLocation = "music/sounds/ogg/"; // ogg sounds location
  ...
  function playAudio() {
    ...
    if (audioSrc.indexOf("{{type}}") > 0) {
      ...
      // Allow for the original relative URLs
